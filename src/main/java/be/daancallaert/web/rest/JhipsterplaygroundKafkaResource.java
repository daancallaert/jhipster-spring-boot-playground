...
@RestController
@RequestMapping("/api/jhipsterplayground-kafka")
public class JhipsterplaygroundKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterplaygroundKafkaResource.class);
    ...
    public JhipsterplaygroundKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
